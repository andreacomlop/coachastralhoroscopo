...
def build_daily_astrology_prompt(fecha_iso: str) -> str:
    parts = [
        f"Hoy es {fecha_iso}.",
        "",
        "Antes de escribir el artículo, identifica y utiliza únicamente movimientos astrológicos reales que estén ocurriendo hoy "
        "(por ejemplo: posición general de la Luna, retrogradaciones activas, aspectos planetarios relevantes a nivel general).",
        "",
        ...
        "",
        "Con esta información real, escribe un artículo diario de astrología general (no por signos) con un enfoque divulgativo, "
        "educativo y cercano, dirigido a personas que no saben astrología pero quieren aprender.",
        "",
        "El artículo debe ser de unas 150 palabras, desarrollado y fácil de leer.",
        "",
